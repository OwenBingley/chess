...
//Miguel M
// Pawn, moves forward one square and captures diagonally forward. Can move forward
//2 spaces if it's the pawn's first move.
package com.example;
...
// poscon: all the squares that the pawn controls on the board, as of the
//square
// given
@Override
