...
//Precondition: The Board object (b) must not be null and will be a 64 square
//board. The start square must be within board b (0-7).
//Postcondition: Returns an ArrayList of possible moves the piece could move to
//(based on the rules of the piece movement)
